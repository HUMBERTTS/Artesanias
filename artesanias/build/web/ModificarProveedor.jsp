<%-- 
    ...
    Created on : 08-oct-2015, 12:12:55
    Author     : humberto
--%>
                    ...
                    <div class="col-lg-8">
                        ...
                        <form role="form">
                            ...
                            <div class="form-group">
                                <label>Clave del proveedor a editar</label>
                                <input class="form-control" required placeholder="Clave de proveedor">
                            </div>

                            <div class="form-group">
                                <label>Nombre del proveedor</label>
                                <input class="form-control" required placeholder="Nombre de proveedor">
                            </div>

                            <div class="form-group">
                                <label>Apellido paterno</label>
                                <input class="form-control" required placeholder="Apellido paterno">
                            </div>

                            <div class="form-group">
                                <label>Apellido materno</label>
                                <input class="form-control" required placeholder="Apellido materno">
                            </div>

                            <div class="form-group">
                                <label>Dirección</label>
                                <input class="form-control" required placeholder="Dirección">
                            </div>

                            <div class="form-group">
                                <label>Teléfono</label>
                                <input class="form-control" required placeholder="Teléfono">
                            </div>

                            <div class="form-group">
                                <label>Tipo de Producto</label>
                                <input class="form-control" required placeholder="Tipo de Producto">
                            </div>
