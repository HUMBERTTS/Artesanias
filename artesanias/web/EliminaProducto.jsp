<%-- 
    ...
    Created on : 08-oct-2015, 12:10:30
    Author     : humberto
--%>
                    ...
                    <div class="col-lg-8">
                        ...
                        <form role="form">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" required placeholder="Clave del Producto">
                            </div>

                            <div class="form-group">
                                <label>Nombre del Producto</label>
                                <input class="form-control" required placeholder="Nombre de producto" disabled>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Costo</label>
                                <input class="form-control" required placeholder="Costo del Producto" disabled>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" required placeholder="Tamaño del producto" disabled>
                            </div>
                            <div align="center">
