<%-- 
    ...
    Created on : 08-oct-2015, 12:10:53
    Author     : humberto
--%>
                    ...
                    <div class="col-lg-8">
                        ...
                        <form role="form">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" required placeholder="Clave del proveedor">
                            </div>

                            <div class="form-group">
                                <label>Nombre del proveedor</label>
                                <input class="form-control" required placeholder="Nombre de proveedor" disabled>
                            </div>

                            <div class="form-group">
                                <label>Descripción del Producto</label>
                                <input class="form-control" required placeholder="Descripción de producto" disabled>
                            </div>

                            <div class="form-group">
                                <label>Apellido paterno</label>
                                <input class="form-control" required placeholder="Apellido paterno" disabled>
                            </div>

                            <div class="form-group">
                                <label>Dirección</label>
                                <input class="form-control" required placeholder="Dirección" disabled>
                            </div>

                            <div class="form-group">
                                <label>Teléfono</label>
                                <input class="form-control" required placeholder="Teléfono" disabled>
                            </div>

                            <div class="form-group">
                                <label>Tipo de producto</label>
                                <input class="form-control" required placeholder="Tipo de producto" disabled>
                            </div>

                            <div class="form-group">
                                <label>Estado</label>
                                <input class="form-control" required placeholder="Estado" disabled>
                            </div>
